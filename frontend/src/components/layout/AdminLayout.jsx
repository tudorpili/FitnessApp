...
import { FiUsers, FiClipboard, FiGrid, FiMenu, FiX, FiLogOut, FiUser, FiBookOpen } from 'react-icons/fi'; // Added FiBookOpen
...
function AdminLayout() {
  ...
  const sidebarNavigation = (
    <nav className="flex-1 space-y-1.5 px-3">
      ...
      <NavLink to="/admin/recipes" className={navLinkClass} onClick={() => setIsSidebarOpen(false)}> <FiBookOpen className="mr-3 h-5 w-5 flex-shrink-0 group-hover:scale-110 transition-transform" /> <span className="truncate">Manage Recipes</span> </NavLink> {/* <-- NEW LINK */}
