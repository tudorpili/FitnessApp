  ...
  return (
    ...
    >
      ...
      <div className="overflow-hidden h-52 relative">
        <img
          // --- FIX: Use recipe.image_url (snake_case) ---
          src={recipe.image_url || 'https://placehold.co/600x400/e0e7eb/a5b4fc?text=Recipe'}
      ...
      <div className="p-5 sm:p-6 flex flex-col flex-grow">
        ...
        {/* Tags */}
        {/* Ensure recipe.tags is an array before mapping */}
