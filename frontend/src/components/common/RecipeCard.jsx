...
import { FiClock, FiUsers, FiHeart, FiTag } from 'react-icons/fi'; // Added FiTag
...
function RecipeCard({ recipe }) {
  ...
  const handleImageError = (e) => {
    ...
    e.target.src = 'https://placehold.co/600x400/e0e7eb/a5b4fc?text=Recipe'; // Nicer placeholder
  };
  ...
  return (
    <Link
      ...
      // Enhanced card styling: glassmorphism, shadow, border, hover effects
    ...
    >
      {/* Image container */}
      <div className="overflow-hidden h-52 relative"> {/* Increased height */}
        <img
      ...
      <div className="p-5 sm:p-6 flex flex-col flex-grow">
        ...
        {/* Description Snippet - Slightly more text */}
        <p className="text-sm text-slate-600 line-clamp-3 mb-4 flex-grow"> {/* Allow more lines */}
        ...
        {recipe.tags && recipe.tags.length > 0 && (
            <div className="flex flex-wrap gap-1.5 mb-4">
                {recipe.tags.slice(0, 3).map(tag => ( // Show max 3 tags
